...
export enum ActiveFeatureFlag {
  ObservabilityV2 = 'OBSERVABILITY_V2',
  ServiceGroups = 'SERVICE_GROUPS',
  StackerWorkflows = 'STACKER_WORKFLOWS',
...
export type TemplateDeployMutationVariables = Exact<{
  ...
  services: Array<TemplateDeployService> | TemplateDeployService;
}>;


export type TemplateDeployMutation = { __typename?: 'Mutation', templateDeploy: { __typename?: 'TemplateDeployPayload', projectId: string, workflowId?: string | null } };
...
export type GithubServiceCreateMutationVariables = Exact<{
  repo: Scalars['String']['input'];
  environmentId: Scalars['String']['input'];
  projectId: Scalars['String']['input'];
  branch: Scalars['String']['input'];
...
export type GithubServiceCreateMutation = { __typename?: 'Mutation', serviceCreate: { __typename?: 'Service', createdAt: any } };

export type ImageServiceCreateMutationVariables = Exact<{
...
export type ImageServiceCreateMutation = { __typename?: 'Mutation', serviceCreate: { __typename?: 'Service', createdAt: any } };
...
export type DeploymentRedeployMutation = { __typename?: 'Mutation', deploymentRedeploy: { __typename?: 'Deployment', status: DeploymentStatus } };
...
export type EnvironmentQuery = { __typename?: 'Query', environment: { __typename?: 'Environment', createdAt: any, projectId: string, updatedAt: any, serviceInstances: { __typename?: 'EnvironmentServiceInstancesConnection', edges: Array<{ __typename?: 'EnvironmentServiceInstancesConnectionEdge', node: { __typename?: 'ServiceInstance', serviceId: string, latestDeployment?: { __typename?: 'Deployment', status: DeploymentStatus, service: { __typename?: 'Service', icon?: string | null, deletedAt?: any | null } } | null, source?: { __typename?: 'ServiceSource', image?: string | null, repo?: string | null } | null } }> } } };
...
export type ServiceQuery = { __typename?: 'Query', service: { __typename?: 'Service', createdAt: any, icon?: string | null, id: string, name: string, projectId: string, templateThreadSlug?: string | null, updatedAt: any, deployments: { __typename?: 'ServiceDeploymentsConnection', edges: Array<{ __typename?: 'ServiceDeploymentsConnectionEdge', node: { __typename?: 'Deployment', canRedeploy: boolean, canRollback: boolean, createdAt: any, environmentId: string, id: string, meta?: any | null, status: DeploymentStatus, updatedAt: any } }> } } };
...
export type TemplateQuery = { __typename?: 'Query', template: { __typename?: 'Template', services: { __typename?: 'TemplateServicesConnection', edges: Array<{ __typename?: 'TemplateServicesConnectionEdge', node: { __typename?: 'TemplateService', config: any, id: string } }> } } };
...
export type DeploymentsQuery = { __typename?: 'Query', deployments: { __typename?: 'QueryDeploymentsConnection', edges: Array<{ __typename?: 'QueryDeploymentsConnectionEdge', node: { __typename?: 'Deployment', canRedeploy: boolean, canRollback: boolean, createdAt: any, environmentId: string, id: string, meta?: any | null, status: DeploymentStatus, updatedAt: any } }> } };
...
export const TemplateDeployDocument = gql`
  ...
  templateDeploy(
    ...
    `;
export type TemplateDeployMutationFn = Apollo.MutationFunction<TemplateDeployMutation, TemplateDeployMutationVariables>;

/**
 * __useTemplateDeployMutation__
 *
 * To run a mutation, you first call `useTemplateDeployMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTemplateDeployMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [templateDeployMutation, { data, loading, error }] = useTemplateDeployMutation({
 *   variables: {
 ...
 * });
 */
export function useTemplateDeployMutation(baseOptions?: Apollo.MutationHookOptions<TemplateDeployMutation, TemplateDeployMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<TemplateDeployMutation, TemplateDeployMutationVariables>(TemplateDeployDocument, options);
      }
export type TemplateDeployMutationHookResult = ReturnType<typeof useTemplateDeployMutation>;
export type TemplateDeployMutationResult = Apollo.MutationResult<TemplateDeployMutation>;
export type TemplateDeployMutationOptions = Apollo.BaseMutationOptions<TemplateDeployMutation, TemplateDeployMutationVariables>;
 ...
 * });
 */
export function useServiceDeleteMutation(baseOptions?: Apollo.MutationHookOptions<ServiceDeleteMutation, ServiceDeleteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type ServiceDeleteMutationOptions = Apollo.BaseMutationOptions<ServiceDeleteMutation, ServiceDeleteMutationVariables>;
export const GithubServiceCreateDocument = gql`
  ...
  serviceCreate(
    ...
    `;
export type GithubServiceCreateMutationFn = Apollo.MutationFunction<GithubServiceCreateMutation, GithubServiceCreateMutationVariables>;

/**
 * __useGithubServiceCreateMutation__
 *
 * To run a mutation, you first call `useGithubServiceCreateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useGithubServiceCreateMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [githubServiceCreateMutation, { data, loading, error }] = useGithubServiceCreateMutation({
 *   variables: {
 *      repo: // value for 'repo'
 *      environmentId: // value for 'environmentId'
 *      projectId: // value for 'projectId'
 ...
 * });
 */
export function useGithubServiceCreateMutation(baseOptions?: Apollo.MutationHookOptions<GithubServiceCreateMutation, GithubServiceCreateMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GithubServiceCreateMutation, GithubServiceCreateMutationVariables>(GithubServiceCreateDocument, options);
      }
export type GithubServiceCreateMutationHookResult = ReturnType<typeof useGithubServiceCreateMutation>;
export type GithubServiceCreateMutationResult = Apollo.MutationResult<GithubServiceCreateMutation>;
export type GithubServiceCreateMutationOptions = Apollo.BaseMutationOptions<GithubServiceCreateMutation, GithubServiceCreateMutationVariables>;
export const ImageServiceCreateDocument = gql`
  ...
  serviceCreate(
    ...
    `;
export type ImageServiceCreateMutationFn = Apollo.MutationFunction<ImageServiceCreateMutation, ImageServiceCreateMutationVariables>;

/**
 * __useImageServiceCreateMutation__
 *
 * To run a mutation, you first call `useImageServiceCreateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useImageServiceCreateMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [imageServiceCreateMutation, { data, loading, error }] = useImageServiceCreateMutation({
 *   variables: {
 ...
 * });
 */
export function useImageServiceCreateMutation(baseOptions?: Apollo.MutationHookOptions<ImageServiceCreateMutation, ImageServiceCreateMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ImageServiceCreateMutation, ImageServiceCreateMutationVariables>(ImageServiceCreateDocument, options);
      }
export type ImageServiceCreateMutationHookResult = ReturnType<typeof useImageServiceCreateMutation>;
export type ImageServiceCreateMutationResult = Apollo.MutationResult<ImageServiceCreateMutation>;
export type ImageServiceCreateMutationOptions = Apollo.BaseMutationOptions<ImageServiceCreateMutation, ImageServiceCreateMutationVariables>;
export const DeploymentRollbackDocument = gql`
    mutation DeploymentRollback($deploymentId: String!) {
  deploymentRollback(id: $deploymentId)
}
    `;
export type DeploymentRollbackMutationFn = Apollo.MutationFunction<DeploymentRollbackMutation, DeploymentRollbackMutationVariables>;

/**
 * __useDeploymentRollbackMutation__
 *
 * To run a mutation, you first call `useDeploymentRollbackMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeploymentRollbackMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deploymentRollbackMutation, { data, loading, error }] = useDeploymentRollbackMutation({
 *   variables: {
 *      deploymentId: // value for 'deploymentId'
 *   },
 * });
 */
export function useDeploymentRollbackMutation(baseOptions?: Apollo.MutationHookOptions<DeploymentRollbackMutation, DeploymentRollbackMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeploymentRollbackMutation, DeploymentRollbackMutationVariables>(DeploymentRollbackDocument, options);
      }
export type DeploymentRollbackMutationHookResult = ReturnType<typeof useDeploymentRollbackMutation>;
export type DeploymentRollbackMutationResult = Apollo.MutationResult<DeploymentRollbackMutation>;
export type DeploymentRollbackMutationOptions = Apollo.BaseMutationOptions<DeploymentRollbackMutation, DeploymentRollbackMutationVariables>;
export const DeploymentRedeployDocument = gql`
  ...
  deploymentRedeploy(id: $deploymentId) {
    ...
    `;
export type DeploymentRedeployMutationFn = Apollo.MutationFunction<DeploymentRedeployMutation, DeploymentRedeployMutationVariables>;

/**
 * __useDeploymentRedeployMutation__
 *
 * To run a mutation, you first call `useDeploymentRedeployMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeploymentRedeployMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deploymentRedeployMutation, { data, loading, error }] = useDeploymentRedeployMutation({
 *   variables: {
 *      deploymentId: // value for 'deploymentId'
 *   },
 * });
 */
export function useDeploymentRedeployMutation(baseOptions?: Apollo.MutationHookOptions<DeploymentRedeployMutation, DeploymentRedeployMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeploymentRedeployMutation, DeploymentRedeployMutationVariables>(DeploymentRedeployDocument, options);
      }
export type DeploymentRedeployMutationHookResult = ReturnType<typeof useDeploymentRedeployMutation>;
export type DeploymentRedeployMutationResult = Apollo.MutationResult<DeploymentRedeployMutation>;
export type DeploymentRedeployMutationOptions = Apollo.BaseMutationOptions<DeploymentRedeployMutation, DeploymentRedeployMutationVariables>;
 ...
 * });
 */
export function useEnvironmentQuery(baseOptions: Apollo.QueryHookOptions<EnvironmentQuery, EnvironmentQueryVariables> & ({ variables: EnvironmentQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useGithubReposSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GithubReposQuery, GithubReposQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GithubReposQuery, GithubReposQueryVariables>(GithubReposDocument, options);
        }
...
export type GithubReposSuspenseQueryHookResult = ReturnType<typeof useGithubReposSuspenseQuery>;
...
export const DeploymentsDocument = gql`
  ...
  deployments(
    input: {serviceId: $serviceId, projectId: $projectId, environmentId: $environmentId}
  ) {
    edges {
      node {
        canRedeploy
 ...
 * });
 */
export function useDeploymentsQuery(baseOptions: Apollo.QueryHookOptions<DeploymentsQuery, DeploymentsQueryVariables> & ({ variables: DeploymentsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
